    ...
    return (
        <div className='result'>
            ...
            <div className='result__footer'>
                ...
                <a href={"https://www.tfprint.ru/new-kviz-2023/build/printers/printers" + result + ".pdf"} download className='main__button button' style={{ textDecoration: "none" }}>Скачать</a>
            </div>
        </div>
